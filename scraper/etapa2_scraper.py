...
- tipo_real (Apartamento/Casa/Terreno/etc.), quartos, data_fim, ocupacao
- matricula_s3_url, scraped_at.

Novos campos v2: fgts (alias aceita_fgts), area (m2), quartos, data_fim, ocupacao.
...
if data_fim:
   ...
   logger.info(f"[diag {numero_imovel}] data_fim extraida: {data_fim}")
