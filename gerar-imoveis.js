...
function pagina(i){
  ...
  // ---- documentos ----
  const docs = [];
  if(matriculaUrl) docs.push(['<a class="doc" href="'+esc(matriculaUrl)+'" target="_blank" rel="noopener">&#128196; Matricula (PDF)</a>']);
  docs.push(['<a class="doc" href="'+esc(fichaCaixa)+'" target="_blank" rel="noopener">&#128196; Ficha / Edital na Caixa</a>']);
